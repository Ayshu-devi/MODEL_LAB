...
public class qn5
{
    ...
    {
        PropertyConfigurator.configure("C:\\Software testing\\qn5\\app.log\\");
    ...
    public void test3() throws InterruptedException
    {
        ...
        WebElement reviewTextbox = driver.findElement(By.xpath("/html/body/footer/section[1]/div/div[1]/div[2]/div/div/div/div/form/div[2]/textarea"));
        reviewTextbox.click();
        reviewTextbox.sendKeys("Excellent");

        WebElement continueButton = driver.findElement(By.xpath("/html/body/footer/section[1]/div/div[1]/div[2]/div/div/div/div/form/div[3]/input"));
